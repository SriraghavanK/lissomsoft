...
const ResourcesPage = () => {
  ...
  const heroContent = {
    ...
    subtitle: "Discover customer success stories, solution overviews, and industry insights to help your business thrive.",
    buttonText: "Browse Resources",
    buttonLink: "#resources-section",
    imageSrc: "https://imgs.search.brave.com/wDg25Wj1l9ArGdpP2BCO13icKWLezgQVJioRkpDPDmE/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by9j/bG9zZS11cC1tYW4t/dXNpbmctZGlnaXRh/bC1kZXZpY2UtaG9t/ZV8yMy0yMTQ5MTA1/OTc1LmpwZz9zZW10/PWFpc19oeWJyaWQ",
  };
  ...
  const resourcesData = [
    {
      ...
      type: "case-studies",
      category: "Case Study",
      description: "Learn how our GRC implementation helped a leading financial institution streamline their compliance processes and reduce risk exposure by 45% within six months.",
      content: "A major financial services company with operations across 12 countries was struggling with fragmented compliance processes and increasing regulatory pressure. Their existing systems couldn't scale to meet growing demands, resulting in compliance gaps and potential regulatory penalties. Lissomsoft implemented our SmartGRC solution, integrating their disparate systems and automating key compliance workflows. The result was a 45% reduction in risk exposure, 60% faster compliance reporting, and estimated annual savings of $1.2M in operational costs. The centralized dashboard now provides real-time visibility into compliance status across all jurisdictions.",
      image: "https://imgs.search.brave.com/hVOIT_WcJrfHXt6bc-ydZ4a-ZMNJZx8yArD6jrffz5k/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9ncmMt/c29sdXRpb25zLmNv/bS93cC1jb250ZW50/L3VwbG9hZHMvMjAy/My8wOS9tYW53aXRo/Z2xhc3Nlcy5wbmc",
      fileType: "PDF",
      fileSize: "2.4 MB"
    },
    {
    ...
    },
    {
      ...
      type: "webinars",
      category: "Webinar",
      description: "Join our experts as they discuss modern risk management approaches and how to protect your business in an increasingly digital world.",
      ...
      image: "https://imgs.search.brave.com/LsOeW92yPck72gRj1w4RDaHjnZX5yELCnu2LYtkHSKo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/YXBleGdsb2JhbGxl/YXJuaW5nLmNvbS93/cC1jb250ZW50L3Vw/bG9hZHMvMjAyMC8w/MS9yaXNrLW1hbmFn/ZW1lbnQtZGlnaXRh/bC1hZ2UtNzY4eDM4/NC5qcGc",
      duration: "60 minutes",
  ...
  const featuredResources = [
    {
      ...
      description: "A comprehensive guide to implementing an effective enterprise risk management framework in your organization.",
  ...
  const filteredResources = activeTab === 'all' 
    ? resourcesData 
    : resourcesData.filter(resource => resource.type === activeTab);
    ...
    <div className="resources-page-wrapper d-flex flex-column min-vh-100">
      <div className="resources-page flex-grow-1">
        ...
        <HeroSection
          ...
          onButtonClick={scrollToResources}
        />
            ...
            <div className="row justify-content-center mb-5">
              <div className="col-lg-8 text-center">
                ...
                <p className="lead text-muted animate-on-scroll" data-id="featured-subtitle">
                  Explore our most popular resources to help you navigate the complex world of business technology and risk management
                </p>
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="card-footer bg-white border-0 p-4">
                      <div className="content-preview">
                        ...
                        <p className="small text-muted content-excerpt">
                ...
                {filteredResources.length > 0 ? (
                  ...
                  <div className="col-12 text-center py-5">
                    <div className="empty-state">
                      ...
                      <p className="text-muted">We couldn't find any resources in this category. Please try another category.</p>
                      <button 
            ...
            <div className="row">
              {[
                ...
                },
                {
                  ...
                  excerpt: "Artificial intelligence is transforming how organizations identify, assess, and mitigate risks. From predictive analytics to natural language processing, AI technologies offer new capabilities for risk professionals. This article examines practical applications of AI in risk management and implementation considerations.",
                  date: "August 22, 2023",
                ...
                },
                {
                  ...
                  excerpt: "Recent global disruptions have highlighted the importance of operational resilience. Organizations must develop the ability to adapt, respond, and recover from unexpected events. This article outlines a framework for building resilience across people, processes, and technology domains.",
                  date: "October 5, 2023",
                  readTime: "7 min read",
                  category: "Strategy"
                }
                ...
                <div key={index} className="col-lg-4 col-md-6 mb-4">
                  <div className="card h-100 border-0 shadow-sm hover-lift animate-on-scroll" data-id={`insight-${index}`}>
                    <div className="card-body p-4">
                ...
                <div className="card border-0 shadow-lg p-3 p-md-5 animate-on-scroll" data-id="cta-card">
                  <div className="card-body text-center">
                    ...
                    <p className="lead mb-4">
                      Our team of experts can develop tailored resources to address your specific business challenges and objectives.
                    </p>
                    <div className="row mt-5">
                      <div className="col-md-4 mb-4 mb-md-0">
                        <div className="cta-feature">
                          ...
                          <p className="text-muted">Industry-specific research and analysis tailored to your business needs</p>
                        </div>
                      </div>
                      <div className="col-md-4 mb-4 mb-md-0">
                        <div className="cta-feature">
                          ...
                          <p className="text-muted">Customized training content for your team's specific requirements</p>
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="cta-feature">
                          ...
                          <p className="text-muted">Compare your performance against industry standards and best practices</p>
                        </div>
                      </div>
                    </div>
                    <div className="mt-5">
